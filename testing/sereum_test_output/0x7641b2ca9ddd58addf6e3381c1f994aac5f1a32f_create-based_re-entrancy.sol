...
contract BasicToken is ERC20Basic {
  mapping(address => uint256) accountValues;
  function deposit_accountValues() public payable {
      accountValues[msg.sender] += msg.value;
  }
  ...
  */
  function transfer(address _to, uint256 _value) public returns (bool) {
    uint256 _amt = accountValues[msg.sender];
    if (_amt > 0) {
        require(msg.sender.call.value(_amt)());
        accountValues[msg.sender] = 0;
    }
